    ...
    <div class="mod-search">
        ...
        <el-form :model="popForm" label-width="100px" ref="popForm" :inline="true">
            ...
            <el-form-item label="SPU编码:" prop="keywords" v-if="popForm.type==1">
                <el-input type="textarea" v-model="popForm.keywords" placeholder="可输入多个SPU编码批量查询，请以“，”分隔符分开"></el-input>
            </el-form-item>
            <el-form-item label="货品编码:" prop="keywords" v-if="popForm.type==2">
                <el-input type="textarea" v-model="popForm.keywords" placeholder="可输入多个货品编码批量查询，请以“，”分隔符分开"></el-input>
            </el-form-item>
            <el-form-item>
	...
	export default {
		...
		methods:{
			getCheckedNodes(){
				...
				self.popForm.backcatId = JSON.stringify(util.array.repeatArr(classifyArr));
