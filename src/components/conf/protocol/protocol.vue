...
<template>
<div class="page-view">
	<head-top title="会员注册协议"></head-top>
	<div class="mod-protocol">
		<h1>注册服务条款</h1>
		<div class="passages">
			<p class="passages-tips">
				<b>尊敬的用户，欢迎您注册成为本网站用户。在注册前请您仔细阅读如下服务条款：</b>
			</p>
			<p class="passages-content">
				本服务协议双方为本网站与本网站用户，本服务协议具有合同效力。
			</p>
			<p class="passages-content">
				您确认本服务协议后，本服务协议即在您和本网站之间产生法律效力。请您务必在注册之前认真阅读全部服务协议内容，如有任何疑问，可向本网站咨询，咨询电话：4008-888-881。
			</p>
		</div>
		<div class="passages">
			<p class="passages-tips">
				<b>A．以下特别提示条款对您非常重要，请您仔细阅读：</b>
			</p>
			<p class="passages-tips">
				特别条款：
			</p>
			<p class="passages-tips">
				1.  用户在注册时应当选择稳定性及安全性相对较好的电子邮箱，并且同意接受并阅读本网站发往用户的各类电子邮件。如用户未及时从自己的电子邮箱接受电子邮件或因用户电子邮箱或用户电子邮件接收及阅读程序本身的问题使电子邮件无法正常接收或阅读的，只要本网站成功发送了电子邮件，应当视为用户已经接收到相关的电子邮件。电子邮件在发信服务器上所记录的发出时间视为送达时间。
			</p>
			<p class="passages-tips">
				2． 服务条款的修改
			</p>
			...
			<p class="passages-tips">
				所有发给用户的通知都可通过重要页面的公告或电子邮件或常规的信件传送。服务条款的修改、服务变更、或其它重要事件的通知都会以此形式进行。
			</p>
			<p class="passages-tips">
				用户和本网站一致同意由本网站运营商步步高电子商务有限公司所在地有管辖权的法院为诉讼管辖法院。
			</p>
			<p class="passages-tips">
				B．在您点击协议正本下方的"注册"按钮并按照本网站注册程序成功注册为用户后，即视为您同意并签署了包含前述A项特别提示条款及以下条款在内的服务协议。
			</p>
		</div>
		<div class="passages">
			<p class="passages-tips">
		...
		<div class="passages">
			...
			<p class="passages-content">
				(3)用户点击同意本协议的，即视为用户确认自己具有享受本站服务、下单购物等相应的权利能力和行为能力，能够独立承担法律责任
			</p>
			<p class="passages-content">
				(4)如果您在18周岁以下，您只能在父母或监护人的监护参与下才能使用本站。
			</p>
			<p class="passages-content">
				(5)步步高电子商务有限责任公司保留在中华人民共和国大陆地区法施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消订单的权利。
			</p>
		</div>
		<div class="passages">
			<p class="passages-tips">
				7．用户在本网站上交易平台上不得发布下列违法信息：
			</p>
			<p class="passages-content">
				(1)反对宪法所确定的基本原则的；
			</p>
		...
		<div class="passages passages-last">
			<p class="passages-tips">
				17．法律
			</p>
			<p class="passages-content">
