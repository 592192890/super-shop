	...
	export default {
		...
		methods:{
			...
			onSubmit(){
				...
				if(actType==1){
					setRouter = 'set-merchandise';
					this.form.toolId = '3001';
				}
				if(actType==2){
					setRouter = 'set-order-reduced';
					this.form.toolId = '3000';
				}
				...
				this.$refs['form'].validate((valid) => {
					if(valid){
						...
						self.$router.push('/marketing-management/promotions/reduced/@'+setRouter+idStr);
					}
				});
			},
			onCancel(){
