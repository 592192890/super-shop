<template>
	<div class="mod-block mod-set">
    	<div :class="isView?'block-mask':''">
			<el-form ref="form" :model="form" label-width="140px" class="mod-form mod-msg" :inline="true">
				<div class="mod-search mod-search-list">
					<!-- <el-form label-width="100px" :inline="true" class="mod-msg"> -->
					...
					<!-- <el-form label-width="120px" :inline="true" :model="form" ref="form"> -->
						<el-form-item label="免费额度设置:" class="inline-form">
							<div class="f-l text">以下类目商品单笔购买满</div>
							<div class="f-l input">
				...
				<div class="mod-opr-btn">
					<el-button @click="addPartClass">添加分类</el-button>
					<el-button @click="importGoods">导入分类</el-button>
				</div>
				...
				<el-table :data="form.tableData" v-loading="form.listLoading" v-if="form.tableData.length">
					...
					<el-table-column prop="upCatePath" label="上级分类">
					</el-table-column>
